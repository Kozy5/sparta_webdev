CPU와 메모리
[강의 전 간단한 한마디]
CPU 성능/작동방식          = 64비트 프로세서,L2/L3캐시,주파수 등
CPU 핵심 동작              = 데이터 가져오기, 디코딩,실행
CPU 구성요소,컴퓨터구성    = 레지스터,제어장치,연산장치    
...
● 우리는 키보드를 통해 파일에 문자를 입력하도록 명령하고 연산을 작성한 뒤 
엔터키를 눌러서 연산 수행 및 저장을 명령 할 수 있습니다.

● 또한 마우스를 통해 폴더를 열거나 파일 실행하도록 명령하고 컴퓨터 설정을 변경 할 수 있습니다.
